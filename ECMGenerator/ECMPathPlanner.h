...
namespace ECM
{
	...
	namespace PathPlanning
	{
		...
		private:
			...
			void CreateCorridor(const std::vector<const ECMHalfEdge*>& maPath, Corridor& outCorridor, std::shared_ptr<ECM> ecm); // A* search on medial axis, returns set of edges
